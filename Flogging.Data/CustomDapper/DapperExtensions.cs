...
namespace Flogging.Data.CustomDapper
{
    ...
    {
        public static int DapperProcNonQuery(this IDbConnection db,
            string procName,
            ...
            int? timeoutSeconds = null)
        {
            ...
            {
                var ex = new Exception($"Dapper proc execution faailed!", orig);
                AddDetailsToException(ex, procName, paramList);
                throw ex;
            }
        }

        private static void AddDetailsToException(Exception ex,
            string procName,
            object paramList)
        {
